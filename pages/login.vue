...
useSeoMeta({
  title: 'Login',
  description: 'Sign in to your Unlistened.me account and access saved podcasts, bookmarks, and playlists.',
})
  ...
  <div class="flex min-h-screen flex-col justify-center bg-gray-950 px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <p class="mt-6 text-center text-sm text-gray-500">
        ...
        <NuxtLink to="/signup" class="font-semibold text-indigo-400 transition-colors hover:text-pink-400">
          Create an account
        </NuxtLink>
      </p>
    </div>
