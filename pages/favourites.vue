...
import { favouritesSeo } from '~/src/seo/registry/index.js'
        ...
        <div class="mb-10">
          ...
          <div class="space-y-2 rounded-2xl border border-gray-800 bg-gray-900/40 p-3 sm:p-4">
            <div v-for="i in 4" :key="i" class="flex items-center gap-3 rounded-lg border border-gray-800 bg-gray-900/40 p-3">
              <div class="h-10 w-10 shrink-0 rounded-md animate-shimmer sm:h-12 sm:w-12" />
            ...
            >
              <template #item="{ element }">
                <div class="group flex items-center gap-2 rounded-lg border border-gray-800 bg-gray-900/40 p-2 transition-colors hover:border-indigo-500/40 hover:bg-gray-800/60 sm:gap-3 sm:p-3">
                  ...
                  <NuxtLink :to="'/feed/' + element.feed_id" class="h-10 w-10 shrink-0 overflow-hidden rounded-md bg-gray-700 sm:h-12 sm:w-12">
                    <img
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p v-if="feedInfo(element)?.author" class="mt-0.5 truncate text-xs text-gray-400">
                      {{ feedInfo(element).author }}
                    </p>
                    <p v-if="feedInfo(element)?.description" class="mt-0.5 hidden line-clamp-1 text-xs leading-relaxed text-gray-500 sm:block">
