...
const FooterNavigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/unlistened.me/',
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/unlistened.me/',
      icon: defineComponent({
        render: () =>
            h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
              h('path', {
    ...
    {
      name: 'X',
      href: 'https://x.com/unlistened_me',
      icon: defineComponent({
        render: () =>
            h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
              h('path', {
...
<template>
  <div class="bg-white border-t-gray-100 border-2">
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
      ...
      <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; {{ currentYear }} Unlistened.me  all rights reserved. Powered by <a href="https://gianlucatiengo.com/" target="_blank" class="text-gray-400 hover:text-pink-500">Gianluca Tiengo</a></p>
    </div>
  </div>
</template>
<script>
