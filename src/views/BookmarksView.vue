...
<template>
  ...
  <div v-if="!bookmarks[0]" class="bg-white px-6 pb-24 sm:pb-32 lg:px-8">
  ...
  <div v-else class="pb-24 bg-white">
    <div class="bg-white pb-12 sm:pb-12">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Organize your bookmarks</h2>
                ...
                <div class="mx-auto max-w-7xl px-3 py-3 sm:px-6 lg:px-8">
                  <div class="flex flex-wrap items-center justify-between">
                    ...
                    <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                      <button @click="deleteBookmark(element.episode_id, 'main')" type="button" class="-mr-1 py-2 px-4 mx-1 rounded-full flex p-2 hover:bg-white focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2 text-white hover:text-red-600">
              ...
              <div  class="bg-indigo-600 border-solid border-4 border-white rounded-2xl">
                <div class="mx-auto max-w-7xl px-3 py-3 sm:px-6 lg:px-8">
                  <div class="flex flex-wrap items-center justify-between">
                    ...
                    <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                      <button @click="deleteBookmark(element.episode_id, section.name)" type="button" class="-mr-1 py-2 px-4 mx-1 rounded-full flex p-2 hover:bg-white focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2 text-white hover:text-red-600">
                        <span class="sr-only">Dismiss</span>
                        <TrashIcon class="h-5 w-5" aria-hidden="true" />
                      </button>
                    </div>
