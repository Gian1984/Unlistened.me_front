    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="text-center grid min-h-full place-items-center bg-white pb-24 sm:pb-32">
        ...
        <p class="mt-6 text-base leading-7 text-gray-600">
          We're sorry, but we are unable to find the episode you are looking for. It may have been deleted or moved. Please use the search input field above and enter the title of the podcast to search again. We appreciate your understanding and hope you find what you're looking for!
        </p>
