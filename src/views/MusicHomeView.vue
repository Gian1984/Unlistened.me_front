  ...
  <div class="bg-gray-950 min-h-screen">
    <div class="p-6 sm:p-8">
      ...
      <div class="mb-8 flex flex-wrap items-center gap-2">
        <router-link
          :to="{ name: 'MusicAlbums' }"
          class="inline-flex items-center rounded-full border border-gray-700 bg-gray-900 px-4 py-2 text-sm font-medium text-gray-300 transition-colors hover:border-indigo-500/40 hover:text-indigo-300"
        >
          Browse albums
        </router-link>
      </div>
