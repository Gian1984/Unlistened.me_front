          ...
          <div class="mt-16 space-y-20 lg:mt-20 lg:space-y-20">
            <article class="relative isolate flex flex-col gap-8 lg:flex-row">
              <div class="relative aspect-square lg:w-64 lg:shrink-0">
                <img :src="feedInfo.image || '/images/image_not_available_500.webp'" alt="" class="absolute inset-0 w-full aspect-square rounded-2xl bg-gray-50 object-cover" />
              ...
              <div>
                ...
                <div class="group relative max-w-xl">
                  <h2 class="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600">
                    <span class="text-gray-900 font-bold">{{ episode.title }}</span>
                  </h2>
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="text-center grid min-h-full place-items-center bg-white pb-24 sm:pb-32">
          ...
          <p class="mt-6 text-base leading-7 text-gray-600">
            We're sorry, but we are unable to find the feed you are looking for. Please use the search to try again.
          </p>
          <div class="mt-10 flex items-center justify-center gap-x-6">
